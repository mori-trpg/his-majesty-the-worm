...
Tomb of Golden Ghosts Meatgrinder
...
pattern recognition
The recurring pattern of murals hiding hidden
doors provides contextual clues for players. If
...
Appendix C; rebrand if necessary

• Combine a theme and threat, then rekajigger
...
first visit to a particular dungeon level, they
might have an epiphany later and return.
...
would handle a shop keeper or a falling rock.
...
Meatgrinder event XVI (puppet-mummies)
for 109? Double mummies?! In this case, simply
declare that the two groups are one and the
same: just say that there are [adventurer]
number puppet-mummies here.
...
• Use the Web greater doom if you know you can hit.
...
as you have enough cards).

Both brain spiders have the following statistics:
...
Notes
• Squishy. Brain spiders are immune to bludgeoning and

smashing weapons such as hammers and maces.

• Telepathic. The brain spider speaks telepathically.

They can communicate with anyone, regardless of the
languages they speak.

Lesser dooms
• Great Leap. The brain spider can jump 2 zones when
Dashing. When doing so, they clear any intervening
obstacles (avoiding pits, hazardous terrain, adventurers
blocking the way, etc.).

• Wall Crawling. The brain spider can effortlessly climb
on walls. If a brain spider Moves onto a wall, it can
avoid the adventurers and leave the area (unless the
adventurers have some way to keep up).
...
greater doom card to cast a web on a single target. If
successful, the Attack deals no damage but the target
is completely wrapped in webs. They can free one limb
at a time using the Recover action and are Rooted
until all limbs have been freed.

386386

APPENDIX E     |     UNDERWORLD CREATION

Dire centipedes (room 103)
Deep-sea gigantism is the phenomenon wherein isopods
and squids grow terrifyingly large in the deepest parts of
the ocean. The effect is even worse in the Underworld,
where centipedes can grow as large as crocodiles.

Likes: Soft Earth, Easy Sources of Food

Puppet-mummies (room 109)
Mummified corpses, rigged up and given jerky motion
by the webs of the brain spiders. Not actually undead
creatures, merely a diabolical machination.

Puppet-mummy tactics
• Gang up on the adventurer with the lowest Initiative.

Hates: Fire

• Roughhouse to disarm adventurers.

Dire centipede tactics
• Gang up on the adventurer with the lowest Initiative.

• Use miscellaneous actions to kick disarmed weapons or

torches into the river.

• Play high cards for Initiative.

Attributes: Swords 0 | Pentacles 0 | Cups 0 | Wands 0

• Use Trample to attack characters with facedown

Health/Defense: 1/0

defensive cards.

Dire centipedes have the statistics of beast minions.
...
Notes
• Fleet. On its turn, a centipede can Move 1 zone

without spending a card.

Lesser dooms
• Trample. On an unsuccessful Attack, a centipede may
use their Attack action against a second target in the
same zone.

Notes
• Marionette Corpses. Puppet-mummies are not undead;

they are just corpses animated by webs. They are
neither affected by things that would affect the living
(poisons, illusions) or the undead (necromantic spells).

Greater dooms
• Last Grasp. When the puppet-mummy would take a
Wound, discard a greater doom instead. The puppet-
mummy takes no Wound, but one of its limbs is
severed. The limb continues to attack independently.
...
Lesser dooms
• Protoplasmic Attack. On a successful Roughhouse, the
target is engulfed. The target is Rooted, moving with
the slime. Additionally, at the beginning of their turn,
...
deal 1 Wound to all creatures currently engulfed. This
does not count against the one card per turn limit.

• Regenerate. Discard a greater doom card to Heal

the slime. This power cannot be used if salt has been
spread on it this turn. This does not count against the
one card per turn limit.

Slime (room 113)
Slimes are like amoebas at a macroscale. Though they
may look like translucent trash bags, their insides are
actually crushing muscles. Anything that a slime engulfs
is quickly eviscerated.

Likes: Warmth, Movement, Dead Corpses to Crush
and Digest

Hates: Elephants (no one knows why), Salt, Fire

Slime tactics
• Attack adventurers carrying a light source.

• Play high cards for Initiative.

• Roughhouse to engulf adventurers, then Grind.

Attributes: Swords X* | Pentacles X* | Cups 0 | Wands 0

Health/Defense: 6/0

* Slimes have Swords and Pentacles ratings equal to their
current Health.

Notes
• Acidic. Weapons that damage a slime are automatically

Notched.

• Impermeable Membrane. Slimes are immune to

slashing weapons (like swords) and crushing weapons
(like hammers). They take damage as normal from
sharp, piercing attacks (like from arrows, daggers, or
spears).

• Salt Reactive. If an adventurer has salt in hand, they
can attempt to throw it onto a slime. This is treated
as an Attack that inflicts 2 Wounds to the slime on a
success.

• Shapeless Body. Slimes are immune to being

Displaced, Rooted, or Tripped.
...
Index
A
|                           | Free actions  116      | Disarm  12     |
| ------------------------- | ---------------------- | -------------- |
| Afflictions  97           | Interrupt actions  114 | Disengage  109 |
| Aid Another (action)  118 | Minor actions  115     | Displace  12   |
Alchemy  78, 164, 229, 232, 235 Miscellaneous actions  120 Disposition  99
| Ambushes  110 | Pentacles actions  117 | Anger  101 |
| ------------- | ---------------------- | ---------- |
Ancient tongues  29 Swords actions  116 Dislikes and likes, wants and needs
| Animal companions  34, 78  | Wands actions  119 | 180, 245 |
| -------------------------- | ------------------ | -------- |
 See also Talent: Beast Master Challenge cards  112 Distaste  101
| Commands  78, 118 | Facedown cards  114 | Fear  102 |
| ----------------- | ------------------- | --------- |
Animate Object (spell)  217 GMing the Challenge  121 Joy  102
| Arête  28 | Out of cards  121 | Sadness  101 |
| --------- | ----------------- | ------------ |
See also individual kin entries The Fool  114 Starting Disposition  100
Armor  124, 163, 164 Challenge Phase  108, 121, 184 Surprise  102
| Attack (action)  116 | Change Size (spell)  217 | Trust  101 |
| -------------------- | ------------------------ | ---------- |
Attributes  8, 23 Character creation  20, 126  Dodge (action)  117
Augury (spell)  223  See also Call to Adventure Dungeon design checklist  335
Avoid (action)  117 Charm (spell)  224 Dungeon Lord (threat)  251
| Axe  170 | Chivalric  29                     | Dungeon seeds  343 |
| -------- | --------------------------------- | ------------------ |
|          | Circle of Protection (spell)  224 | Dwarves  60        |
B
|                       | City Actions  156, 296 | Dwarf arête  61 |
| --------------------- | ---------------------- | --------------- |
| Banking (action)  156 | City Events  150       |                 |
E
| Banter (action)  119 | City Phase  148, 190, 290 |     |
| -------------------- | ------------------------- | --- |
Beast (theme)  247 Command (action)  118 Earthblooded orcs  64
Beg and Busk (action)  156 Commission Craft (action)  158 Effects  12
| Belt  37, 120  | Components  159, 199 | Elemental (theme)  247 |
| -------------- | -------------------- | ---------------------- |
| Bid lore  32   | Concentration  201   | Elite (threat)  251    |
|  See also Lore | Conditions  31       | Engagement  109        |
Bid Lore (action)  120 Contracts  46, 154, 161 Enrage (spell)  217
| Binding (spell)  223 | Control  12 | Exhaust  12 |
| -------------------- | ----------- | ----------- |
Blade  170 Control Animal (spell)  211 Experience  33, 46, 156, 158
| Blind  12 | Control Undead (spell)  205 |     |
| --------- | --------------------------- | --- |
F
| Bombs  232              | Crafting  59, 156, 158      |                        |
| ----------------------- | --------------------------- | ---------------------- |
| Bonds  26               | Crawl Phase  86, 178        | Falling  96            |
| Bow  170                | Critical damage  125        | Fame  46, 149          |
| Brainfever (spell)  205 | Crossbow  170               | Familiars  34, 78      |
| Break bread  140        | Cups (Attribute)  8, 23, 77 | Far Realms  198        |
| Brute (threat)  250     | Curse  12                   | Favor and disfavor  10 |
| Build (action)  156     |                             | Fay  54                |
D
Fear (spell)  205
C
|     | Dagger  170 | Feather (spell)  224 |
| --- | ----------- | -------------------- |
Call to Adventure  20, 126 Dark elves  56 Fellowship (action)  137
Camp Actions  137, 156 Dark elf arête  57 Fireblooded orcs  64
| Camp Phase  136, 188  | Darklight (spell)  205 | Flail  170              |
| --------------------- | ---------------------- | ----------------------- |
...
G
|     | Marching order  43 | Retirement  38 |
| --- | ------------------ | -------------- |
Give Form to Nothingness (spell)  218 Meatgrinder  91, 340, 376 Retreating  124
| Gnomes  57      | Minion (threat)  250    | Riposte (action)  116 |
| --------------- | ----------------------- | --------------------- |
| Gnome arête  57 | Minor actions  115, 123 | Root  13              |
Gold  37, 154, 158, 163 Mirror Meld (spell)  218 Roughhouse (action)  117
| Greater dooms  123 | Mob rule  122 | Rumor mill  87 |
| ------------------ | ------------- | -------------- |
| Grow/Shrink  12    | Morale  119   |                |
S
| Guardian Angel (spell)  224 | Motifs  24           |                           |
| --------------------------- | -------------------- | ------------------------- |
| Guild  42                   | Move (action)  120   | Scout Ahead (action)  137 |
| Guild role  43              | Moving carefully  91 | Scry (spell)  219         |
| Guild sigil  42             |                      | Seablooded orcs  64       |
N
| Guild terms  42           |                           | Seal Pact (spell)  226 |
| ------------------------- | ------------------------- | ---------------------- |
| Guild roster  42          | Necromancy (spell)  208   | Session 0  18          |
| Gust of Wind (spell)  211 | Notch  12                 | Shroud (effect)  13    |
|                           | Noteworthy deeds  46, 149 | Shroud (spell)  220    |
H
Signs and portents  153
O
| Halflings  60       |                           | Silence  13            |
| ------------------- | ------------------------- | ---------------------- |
| Hammer/mace  170    | Oils  232                 | Sleep (spell)  220     |
| Hangover table  157 | Omphalic Market  162, 293 | Slots  37              |
| Heal  12            | Orcs  62                  | Sorcerous (theme)  248 |
Health and Defense (HD)  125 Orc arête  65 Sorcery  82, 159, 197, 205, 211, 217, 223
Heavenfire (spell)  225 Overland travel  142 Speak Incantation (action)  119
| High elves  56     | Oversized  37 | Speak to Animal (spell)  212 |
| ------------------ | ------------- | ---------------------------- |
| High elf arête  57 |               | Spells  199                  |
P
| Hold a Funeral (action)  158 |                       |  See also Components      |
| ---------------------------- | --------------------- | ------------------------- |
| Humans  50                   | Pack  37, 118         | Spells of the Wastes  205 |
| Human arête  53              | Pacts  83             | Spells of the Weald  211  |
| Hunt (action)  137           | Path of Cups  77      | Spells of the Weird  217  |
|                              | Path of Pentacles  73 | Spells of the Welkin  223 |
I
|     | Path of Swords  69 | Spirit (theme)  248 |
| --- | ------------------ | ------------------- |
Illusion (spell)  218 Path of Wands  81 Staggered (condition)  31
| Initiative  112, 114 | Patrol (action)  137 | Starving  140 |
| -------------------- | -------------------- | ------------- |
Injured (condition)  31 Pentacles (Attribute)  8, 23, 73 Stinking Cloud (spell)  208
| Inspire  12            | Piercing damage  125 | Stormblooded orcs  64    |
| ---------------------- | -------------------- | ------------------------ |
| Interrupt actions  114 | Polearm 170          | Strategist (threat)  250 |
Iron  164, 201 Portable Hole (spell)  219 Stressed (condition)  31, 96
| Item durability  96  | Potions  232 | Stun  13 |
| -------------------- | ------------ | -------- |
Item slots  37 Prepare Components (action)  159 Support (action)  159
|     | Protection from the Elements (spell)   | Swords (Attribute)  8, 23, 69 |
| --- | -------------------------------------- | ----------------------------- |
K
212
T
| Kin  23      | Pull Item from Belt (action)  120  |             |
| ------------ | ---------------------------------- | ----------- |
| Kith  23     | Pull Item from Pack (action)  118  | Talents  33 |
| Knockout  12 | Push fate  9                       | Acrobat  74 |
Aegis  70
| L   | Q   |     |
| --- | --- | --- |
Akashic Consciousness  57
| Languages  29     | Quests  24, 91 | Alchemy  78  |
| ----------------- | -------------- | ------------ |
| Lesser dooms  122 |                | Ambusher  74 |
R
| Life (spell)  225 |     | Area Sense  57 |
| ----------------- | --- | -------------- |
Light  94, 166, 167, 169 Raise Zombie (spell)  208 Beast Master  78
| Lore  32        | Read a Book (action)  137 | Berserkergang  64 |
| --------------- | ------------------------- | ----------------- |
| Loud noises  91 | Reagents  231             | Blur  64          |
|                 | Recover (action)  119     | Bookworm  78      |
M
|     | Recovery (Camp Phase)  141 | Byname  53 |
| --- | -------------------------- | ---------- |
Malediction (spell)  206 Reload Crossbow (action)  120 Chirurgeon  78
Maleficence  201, 202, 203 Research (action)  159 Con Artist  74
| Man (theme)  248 | Resolve  32                    | Colossal 61 |
| ---------------- | ------------------------------ | ----------- |
| Maps  90, 334    | Rest and Recover (action)  137 | Counsel  78 |
INDEX 391

Traps  370
Treasure  182
Trip  13
Trivial Action (action)  120
Trolls  60
...
U
Unarmed combatants  116
Undead (theme)  249
Underfolk  58

Underfolk arête  61
Underworld  179, 331
Update Maps (action)  139
Upkeep  154, 163
Use an Item (Camp action)  139
Use Item (action)  118, 232

V
Veritas (spell)  226
Vetus  29
Vigilance (action)  120
Vulgaris  29

W
Wall of Elements (spell)  214
Wands (Attribute)  8, 23, 81
Wastes  202, 205
Watches  90
Weald  202, 211
Weapons  170
...
Labor Unending  60
Loremaster  79
Magic of the Wastes  82
Magic of the Weald  82
Magic of the Weird  82
Magic of the Welkin  82
Monster Hunter  70
Poison Blood  64
Proud and Ancient  51
Quick!  74
Quicksilver Blood  64
Read the Past  56
Reaver  71
Sneak  74
Spout Doom  57
...
Turncloak  53
Two-handed Focus  71
Uncanny Knowledge  57
Underfoot 61
Up My Sleeve  74
War Stories  71
Weird, Wise, Ancient  57
...
Taxes  149
Test Fate (action)  120
Test of fate  8

Bound by fate  11
Favor and disfavor  10
Great failure  8
Great success  8
Group tests  11
Pushing fate  9
...
Themes  247
Threats  250
Thunderclap (spell)  212
Totem (spell)  212
Train (action)  139, 159
