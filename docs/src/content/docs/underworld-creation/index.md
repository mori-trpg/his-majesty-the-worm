...
5. 建立絞肉機
為每一個獨立的地城層建立一張絞肉機（[探索階段](/crawl-phase/)）。

步驟1和2針對整個地下世界只需進行一次。步驟3至5則須針對每個地城層重複執行。從小規模開始，一遍又一遍地重複，直到你的地下世界真正達到神話般的規模。

此外，我們提供了地城種子作為啟發靈感的提示，適用於你地下世界的不同層級——[地城種子](/underworld-creation/dungeon-seeds/)。你可以使用這些地城種子來點燃想像力，也可以完全按照自己的構思來建構地下世界。
...
若要隨機生成你的地下世界佈局，取出大阿爾卡那牌組並抽取幾張牌。牌的數值可對應[地城種子](/underworld-creation/dungeon-seeds/)中的地城種子。這個流程讓你同時獲得地下世界的一個橫截面與縱深剖面：
...
記住，玩家會收到這張地圖的基本版本，讓桌上所有人都能掌握大致情況！創建一份地圖副本，其中包含玩家在進入時能察覺到的大多數房間和通道輪廓，以及你索引鍵中對應的房間編號（但不包含任何內容資訊）。務必留出充裕的空白區域，供玩家繪製他們發現的其他房間和秘密。[探索階段](/crawl-phase/)。

## 4. 撰寫房間描述

房間描述定義了地城的永久性特徵：其危險、寶藏與居民。玩家在這些房間中可能遭遇的非永久性特徵，由絞肉機（[地下世界建構](/underworld-creation/)）負責處理。為每座地城中的每個房間創造值得玩家互動的有趣事物。
...
在撰寫自己的房間描述時，以這些元素作為清單逐一核對。我們從[房間與陷阱](/underworld-creation/rooms-and-traps/)起提供了示範地城特徵和陷阱供你參考使用。
...
使用項目符號來嵌套那些玩家只有透過與房間互動才能發現的資訊。這讓你能快速區分最初描述的內容，與玩家調查特定區域時才描述的內容；[主持人指南](/gamemastering/)的「我能看到什麼？」。
...
玩家在寫下他們的任務（[冒險者創建](/adventurer/creation/)）時，已經告訴了你他們想要什麼。你的地城獎勵可以與這些任務相關，也可以更普遍地適用。例如：
...
在規劃社交遭遇時，不要忽視城市中使用的眾多語言（[冒險者創建](/adventurer/creation/)）。讓不同的生物說不同的語言——或根據對方使用的語言提供情境不同的資訊——可以獎勵冒險者的語言廣度，並讓不同的玩家各有發光的時刻。
...
下一頁有一張空白的絞肉機範本可供填寫。注意[探索階段](/crawl-phase/)描述了不同絞肉機結果的功能。在此，我們將談談創作流程是什麼樣子的。
...
- 一位或多位冒險者必須想出解決方案，或進行命運考驗以避開某個危險的隱患。最典型的例子就是陷阱。[房間與陷阱](/underworld-creation/rooms-and-traps/)關於在遊戲中使用陷阱的論述。

### 隨機遭遇

在隨機遭遇（XVI至XX）期間，公會遇上了一個GM角色或一群GM角色。地下世界中的大多數角色預設並非充滿敵意；如有疑問，GM應隨機決定初始立場（[社交遭遇](/crawl-phase/social-and-example/)）。
